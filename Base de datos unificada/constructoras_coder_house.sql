...
--
-- Dumping data for table `compras_materiales`
--

LOCK TABLES `compras_materiales` WRITE;
/*!40000 ALTER TABLE `compras_materiales` DISABLE KEYS */;
INSERT INTO `compras_materiales` VALUES (1,1,1,1,100.00,2400.00,'2024-06-10'),(2,1,2,2,20.00,8200.00,'2024-06-12'),(3,3,3,3,500.00,210.00,'2024-07-01'),(4,3,4,10,15.00,18000.00,'2024-07-10'),(5,6,7,1,400.00,2450.00,'2024-08-01'),(6,6,6,8,300.00,310.00,'2024-08-02');
/*!40000 ALTER TABLE `compras_materiales` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `materiales` VALUES (1,'Cemento Portland','bolsa 50kg',2500.00),(2,'Arena fina','m3',8500.00),(3,'Ladrillo hueco','unidad',220.00),(4,'Hierro 8mm','barra',1800.00),(5,'Hierro 10mm','barra',2600.00),(6,'Caño PVC 110','metro',1500.00),(7,'Caño PVC 40','metro',900.00),(8,'Cable 2.5mm','metro',320.00),(9,'Interruptor térmico','unidad',4200.00),(10,'Pintura látex','balde 20L',18500.00),(11,'Cerámica piso','m2',7200.00),(12,'Yeso','bolsa 30kg',3100.00),(13,'Membrana asfáltica','rollo',14500.00),(14,'Puerta placa','unidad',42000.00),(15,'Ventana aluminio','unidad',68000.00);
...
INSERT INTO `materiales_proyecto` VALUES (1,1,1,80.00),(2,1,2,15.00),(3,1,3,400.00),(4,1,10,8.00),(5,3,1,600.00),(6,3,3,5000.00),(7,3,4,200.00),(8,3,10,40.00),(9,6,1,900.00),(10,6,2,200.00),(11,6,3,8000.00),(12,6,5,300.00);
...
INSERT INTO `pagos_personal` VALUES (1,3,10,2024,5,'2024-05-31',260000.00),(2,3,10,2024,6,'2024-06-30',260000.00),(3,3,10,2024,7,'2024-07-31',260000.00),(4,3,10,2024,8,'2024-08-31',260000.00),(5,3,10,2024,9,'2024-09-30',260000.00),(6,3,10,2024,10,'2024-10-31',260000.00),(7,3,10,2024,11,'2024-11-30',260000.00),(8,3,10,2024,12,'2024-12-31',260000.00),(9,3,10,2025,1,'2025-01-31',260000.00),(10,3,10,2025,2,'2025-02-28',260000.00),(11,3,10,2025,3,'2025-03-31',260000.00),(12,2,5,2024,3,'2024-03-31',380000.00),(13,2,5,2024,4,'2024-04-30',380000.00),(14,2,5,2024,5,'2024-05-31',380000.00),(15,2,5,2024,6,'2024-06-30',380000.00),(16,2,5,2024,7,'2024-07-31',380000.00),(17,2,5,2024,8,'2024-08-31',380000.00),(18,2,5,2024,9,'2024-09-30',380000.00),(19,2,5,2024,10,'2024-10-31',380000.00),(20,2,5,2024,11,'2024-11-30',380000.00),(21,2,5,2024,12,'2024-12-31',380000.00),(43,1,1,2024,12,'2024-12-01',20000.00);
...
INSERT INTO `proveedor_material` VALUES (1,1,1),(2,1,2),(3,1,3),(4,2,1),(5,2,2),(6,2,3),(7,2,6),(8,3,4),(9,3,5),(10,4,10),(11,5,6),(12,6,8),(13,8,14);
...
INSERT INTO `proveedores` VALUES (1,'Corralón El Constructor','30-11111111-1','11-4301-1122','ventas@constructor.com','Warnes 1450, CABA'),(2,'Materiales Barracas','30-22222222-2','11-4362-3344','info@barracas.com','Montes de Oca 1800, CABA'),(3,'Hierros Palermo','30-33333333-3','11-4777-8899','contacto@hierros.com','Av. Córdoba 5100, CABA'),(4,'Pinturerías Color Sur','30-44444444-4','11-4988-7766','ventas@color.com','Av. Independencia 2100, CABA'),(5,'Sanitarios Belgrano','30-55555555-5','11-4511-2233','ventas@sanitarios.com','Av. Cabildo 2300, CABA'),(6,'Electricidad Centro','30-66666666-6','11-4388-9900','contacto@electricentro.com','Av. Jujuy 950, CABA'),(7,'Aceros del Plata','30-77777777-7','11-4922-5566','ventas@aceros.com','Av. La Plata 1400, CABA'),(8,'Maderas Flores','30-88888888-8','11-4633-2211','info@maderasflores.com','Av. Avellaneda 3200, CABA'),(9,'Aberturas Porteñas','30-99999999-9','11-4700-1122','ventas@aberturas.com','Av. Juan B. Justo 2100, CABA'),(10,'Cerámicos Once','30-10101010-1','11-4955-3344','contacto@ceramicos.com','Av. Pueyrredón 900, CABA'),(11,'Vidriería Central','30-20202020-2','11-4380-5566','ventas@vidrios.com','Av. Entre Ríos 1200, CABA'),(12,'Techos y Membranas','30-30303030-3','11-4911-6677','info@techos.com','Av. Directorio 800, CABA'),(13,'Yesos Modernos','30-40404040-4','11-4566-7788','ventas@yesos.com','Av. Nazca 1500, CABA'),(14,'Climatización Urbana','30-50505050-5','11-4377-8899','contacto@clima.com','Av. San Juan 2100, CABA'),(15,'Hormigones Express','30-60606060-6','11-4622-9900','ventas@hormigon.com','Av. Rivadavia 6800, CABA'),(16,'Iluminación Total','30-70707070-7','11-4944-1133','info@iluminacion.com','Av. Corrientes 4300, CABA');
...
-- Dump completed on 2026-02-12 14:37:51
