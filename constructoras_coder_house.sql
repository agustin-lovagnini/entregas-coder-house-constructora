...
INSERT INTO `asignacion` VALUES (1,1,1,'Gerente de Proyecto Principal'),(2,2,1,'Gerente de Proyecto Auxiliar'),(3,1,26,'Representante Legal'),(4,3,27,'Directora de Obra'),(5,4,11,'Director de Obra'),(6,1,12,'Representante Técnico'),(7,5,12,'Representante Técnico'),(8,1,2,'Supervisor de Estructuras'),(9,6,13,'Supervisor de Terminaciones'),(10,7,29,'Diseño Estructural'),(11,8,14,'Jefe de Obra a cargo'),(12,9,28,'Jefe de Obra Adjunto'),(13,10,30,'Cálculo de Fundaciones'),(14,11,31,'Control de Calidad'),(15,1,24,'Ing. Higiene y Seguridad'),(16,1,9,'Supervisor de Seguridad'),(17,12,33,'Supervisor de Seguridad'),(18,13,134,'Control de Riesgos'),(19,14,135,'Control de Riesgos'),(20,15,3,'Coordinador de Logística'),(21,16,50,'Recepción de Materiales'),(22,17,7,'Diseño de Red Eléctrica'),(23,18,10,'Ventas en Sitio'),(24,19,49,'Ventas Corporativas'),(25,20,136,'Asesoría al Cliente'),(26,1,4,'Ingeniero Civil (Obras Viales)'),(27,1,5,'MMO a cargo de Albañilería'),(28,1,6,'Especialista en Suelos y Fundaciones'),(29,1,15,'Capataz General'),(30,1,107,'Capataz de Albañilería'),(31,1,108,'Capataz de Electricidad'),(32,1,16,'Albañil Especializado'),(33,1,36,'Albañil'),(34,1,51,'Albañil'),(35,1,60,'Albañil'),(36,1,67,'Electricista'),(37,1,70,'Electricista'),(38,1,91,'Electricista'),(39,1,19,'Plomero Principal'),(40,1,40,'Plomero Auxiliar'),(41,1,47,'Encofrador'),(42,1,48,'Techista'),(43,6,35,'MMO Auxiliar'),(44,6,34,'Capataz'),(45,6,110,'Capataz'),(46,6,111,'Capataz'),(47,6,17,'Albañil'),(48,6,37,'Albañil'),(49,6,55,'Albañil'),(50,6,83,'Albañil'),(51,6,18,'Electricista'),(52,6,38,'Electricista'),(53,6,68,'Electricista'),(54,6,92,'Electricista'),(55,6,20,'Pintor Principal'),(56,6,72,'Pintor'),(57,6,104,'Yesero'),(58,6,126,'Colocador de Cerámicos'),(59,15,22,'Montador de Estructuras'),(60,15,41,'Plomero'),(61,15,61,'Plomero'),(62,15,112,'Capataz'),(63,15,115,'Capataz'),(64,15,52,'Albañil'),(65,15,56,'Albañil'),(66,15,84,'Albañil'),(67,15,87,'Albañil'),(68,15,23,'Ayudante de Albañil'),(69,15,75,'Ayudante de Albañil'),(70,15,80,'Ayudante de Albañil'),(71,15,96,'Pintor'),(72,15,105,'Yesero'),(73,15,45,'Colocador de Cerámicos'),(74,15,129,'Colocador de Cerámicos');
...
INSERT INTO `proyectos` VALUES (1,1,'Corporate Park Uno','Oficina','Palermo',3,'2024-03-01','2024-11-30'),(2,1,'Centro Comercial Libertador','Local','Palermo',1,'2024-05-10','2024-09-30'),(3,1,'Torre Almagro Residences','Edificio','Palermo',10,'2024-01-15','2026-01-15'),(4,1,'Residencia Echeverria','Casa','Palermo',2,'2024-02-20','2026-02-20'),(5,1,'Chalet Bulnes','Casa','Palermo',1,'2024-04-15','2026-04-15'),(6,1,'Torre Monumental','Edificio','Recoleta',12,'2024-01-01','2031-01-01'),(7,1,'Skyline 3031','Edificio','Recoleta',8,'2024-03-20','2031-03-20'),(8,1,'The Embassy Suites','Edificio','Recoleta',9,'2024-05-01','2029-05-01'),(9,1,'Business Center Callao','Oficina','Recoleta',4,'2024-02-10','2025-02-10'),(10,1,'Galería Alvear','Local','Recoleta',1,'2024-06-01','2024-10-31'),(11,1,'Sede Ministerio Justicia','Departamento Gubernamental','Recoleta',6,'2024-04-01','2025-06-30'),(12,1,'Office Tower Acoyte','Oficina','Caballito',5,'2024-01-25','2025-01-25'),(13,1,'Paseo Rivadavia','Local','Caballito',1,'2024-03-15','2024-09-15'),(14,1,'PH Victoria','PH','Caballito',2,'2024-05-01','2025-05-01'),(15,1,'Torre Río de la Plata','Edificio','Belgrano',15,'2024-01-05','2031-01-05'),(16,1,'Villa Ocampo','Casa','Belgrano',2,'2024-03-01','2026-03-01'),(17,1,'PH Libertador','PH','Belgrano',1,'2024-04-10','2026-04-10'),(18,1,'Edificio Histórico Balcarce','Edificio','San Telmo',7,'2024-02-01','2029-02-01'),(19,1,'Casa Histórica Bolivar','Casa','San Telmo',1,'2024-03-20','2025-03-20'),(20,1,'Vivienda Moderna Defensa','Casa','San Telmo',2,'2024-04-10','2025-04-10'),(21,1,'Mercado Artesanal','Local','San Telmo',1,'2024-05-01','2024-11-01');
/*!40000 ALTER TABLE `proyectos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `staff_asignado_por_proyecto`
--

DROP TABLE IF EXISTS `staff_asignado_por_proyecto`;
/*!50001 DROP VIEW IF EXISTS `staff_asignado_por_proyecto`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `staff_asignado_por_proyecto` AS SELECT 
 1 AS `proyecto`,
...
--
-- Final view structure for view `staff_asignado_por_proyecto`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `unidades_disponibles` AS select `u`.`id_unidad` AS `id_unidad`,`p`.`nombre` AS `nombre_proyecto`,`u`.`tipo_unidad` AS `tipo_unidad`,`u`.`piso` AS `piso`,`u`.`letra_depto` AS `letra_depto`,`u`.`precio` AS `precio` from (`unidades` `u` join `proyectos` `p` on((`u`.`id_proyecto` = `p`.`id_proyecto`))) order by `p`.`nombre`,`u`.`piso`,`u`.`letra_depto` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-12-10 18:34:42
